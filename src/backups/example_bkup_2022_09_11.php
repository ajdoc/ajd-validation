...
try
{
	...
	$v7 = $v
			...
			->minlength(2)->sometimes()->publishFail('minlenght_fiale', function()
			{
				echo 'failed';
			})
			->check('testmedad', ['testmedad' => ['s', 'x']])
			->getPromise()
			->getValidationResult();

		$v7
			->getValidationDefinition()()->middleware('test_middleware2', 'testmedad2', 'e');
