...
class Database
{
    ...
    protected static $select_sub = [];

    protected static $_allowed_joins = [
        'right_join' => 'RIGHT JOIN',
        'left_join' => 'LEFT JOIN',
        'join' => 'JOIN'
    ];

    protected static $_allowed_union = [
        'union' => 'UNION',
        'union_all' => 'UNION ALL',
        'union_distinct' => 'UNION DISTINCT'
    ];

    protected static $_fetch_type_array = [
        'fetch' => self::FETCH,
    ...
    protected static $_no_operator = [
        self::ISNOTNULL,
        self::ISNULL
    ];

    protected static $_special_where = [
        self::BETWEEN,
        self::IN
    ];

    protected static $_sql_function = [
        'lower',
        'upper',
        'concat',
        'ifnull'
    ...
    public function __construct( $connection = NULL, $dbuser= NULL, $dbpass= NULL, $options = [], ...$extra )
    {
    ...
    protected function process_connection( $connection = null, $dbuser = null, $dbpass = null, $options = [], ...$extra )
    {
    ...
    public function execute_query( $query, $params = [], $fetch_type = self::FETCH, $lazy = false )
    {
        $result  = NULL;
        try 
        {
